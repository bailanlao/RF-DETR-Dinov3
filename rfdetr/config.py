...
class RFDETRMediumV3Config(RFDETRBaseConfig):
    """
    The configuration for an RF-DETR Medium DinoV3 model.
    """
    encoder: Literal["dinov3_windowed_small", "dinov3_windowed_base"] = "dinov3_windowed_small"
    out_feature_indexes: List[int] = [3, 6, 9, 12]
    num_windows: int = 2
    dec_layers: int = 4
    patch_size: int = 16
...
class RFDETRNanoV3Config(RFDETRBaseConfig):
    """
    The configuration for an RF-DETR Nano DinoV3 model.
    """
    encoder: Literal["dinov3_windowed_small", "dinov3_windowed_base"] = "dinov3_windowed_small"
    out_feature_indexes: List[int] = [3, 6, 9, 12]
    num_windows: int = 2
    ...
    resolution: int = 384
    positional_encoding_size: int = 24
    # pretrain_weights: Optional[str] = "rf-detr-nano-dinov3.pth"
    pretrain_weights: Optional[str] = None
