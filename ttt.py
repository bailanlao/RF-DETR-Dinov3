...
from rfdetr import RFDETRNano, RFDETRBase, RFDETRMedium, RFDETRLarge, RFDETRMediumV3,RFDETRMediumV3Plus
import torch
...
if __name__ == "__main__":
    ...
    if plus == 'plus':
        ...
        model = RFDETRMediumV3(position_embedding='sine',use_fdam=False,pretrain_weights='D:\__easyHelper__\RF-DETR-Dinov3\medium-dinov3-randomdecoder.pth')
        model1=RFDETRMediumV3(position_embedding='sine',use_fdam=True,pretrain_weights='D:\__easyHelper__\RF-DETR-Dinov3\medium-dinov3-randomdecoder.pth')
    ...
    # print(core_model.backbone[0])
    print(core_model.backbone[0].encoder.encoder.embeddings)
    print(core_model.backbone[0].encoder.encoder.encoder)
    batch_size = 3
    height = 320
    width = 320
    channels = 3
    ...
    embedding_output,orig_h,orig_w,win_h,win_w=core_model.backbone[0].encoder.encoder.embeddings(x)
    print(embedding_output.shape)
    encoder_output=core_model.backbone[0].encoder.encoder.encoder(embedding_output, orig_h, orig_w, win_h, win_w, core_model.backbone[0].encoder.encoder.rope_embed, output_hidden_states=True, output_attentions=False, return_dict=False)
